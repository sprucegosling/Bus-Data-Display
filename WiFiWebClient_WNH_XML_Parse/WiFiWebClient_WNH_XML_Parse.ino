...
//char server[]="bbc.co.uk";

using namespace tinyxml2;
XMLDocument xmlDocument;


//char server[] = "data.bus-data.dft.gov.uk/api/v1/datafeed/?api_key=e3be106391929d2f9b3f6b01077797ded90c4f45";//&operatorRef=SCGL&lineRef=23
...
void loop() {
  ...
  while (client.available()) {
    ...
    //char xml_output = xml_output + client.read();

//save this bit
    
//    xmlDocument = client.read();
//    Serial.write(c);
